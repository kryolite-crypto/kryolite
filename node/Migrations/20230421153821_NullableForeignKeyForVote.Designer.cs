...
namespace node.Migrations
{
    ...
    [Migration("20230421153821_NullableForeignKeyForVote")]
    partial class NullableForeignKeyForVote
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kryolite.Shared.Token", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Kryolite.Shared.Token", b =>
                {
                    b.HasOne("Kryolite.Shared.Contract", "Contract")
                        .WithMany("Tokens")
                        .HasForeignKey("ContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("Kryolite.Shared.LedgerWallet", "Wallet")
                        .WithMany("Tokens")
